...
async function initMap() {
    try {
        ...
        const atajos = [
            {
                ...
                content: `
                    <div class="info-window-content">
                        ...
                        <p>Gira a la derecha para tomar un pequeño atajo que cruza una sección del bosque.</p>
                    </div>
                `
            },
            {
                position: { lat: 5.113493, lng: -73.805893 },
                title: 'Atajo 2: Explorando el bosque',
                content: `
                    <div class="info-window-content">
                        <img src="/src/static/utils/Virgen de la Z/Atajo_2_Por_Bosque.jpg" alt="Punto de inicio" style="width:100%;max-width:200px;">
                        <h3>Atajo 2: Explorando el bosque</h3>
                        <p>Gira a la izquierda para atravesar un bosque y llegar directamente a la estación 3. Este atajo es algo accidentado, así que pisa con cuidado para evitar resbalones. Sigue el mapa para mantenerte en el camino.</p>
                    </div>
                `
            },
            {
                position: { lat: 5.115032, lng: -73.805580 },
                title: 'Atajo 3: Directo al monumento',
                content: `
                    <div class="info-window-content">
                        <img src="/src/static/utils/Virgen de la Z/Atajo_Extremo.jpg" alt="Punto final" style="width:100%;max-width:200px;">
                        <h3>Atajo 3: Directo al monumento</h3>
                        <p>Gira a la derecha para tomar un atajo directo al monumento. Este camino es extremadamente inclinado y solo recomendado para senderistas experimentados. Hay riesgo de resbalones, así que mantén la vista en el sendero, que sube por la parte más empinada de la montaña hasta el monumento.</p>
                    </div>
                `
            }
        ];
        ...
        newPolyline(atajoSegundoPath, '#FFA500')
        ...
        newPolyline(atajoTresPath, '#FFA500')
    } catch (error ){
