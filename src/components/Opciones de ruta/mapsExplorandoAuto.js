//  Varibale para detectar si una ruta esta disponible o no
const rutaDisponible = false;
...
const cortinaRutaNoDisponible = document.querySelector('.container-overlay-no-disponible')
const containerHeader = document.querySelector('.container-img');
...
window.addEventListener('load', () => {
    if (!rutaDisponible) {
        ...
        loadingIndicator.style.display = 'none';
        cortinaRutaNoDisponible.style.display = 'flex'
    } else {
