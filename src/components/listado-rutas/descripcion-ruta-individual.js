...
const DescripcionRuta = ( {rutas} ) => {
  ...
  const handleImaheClick = (imgSrc, index) => {
      ...
      <div className='container-info'>
        ...
        <div className='container-info-descrip'>
            ...
            <div className='carrusel-imgs'>
              {
                rutas.imgs.map((imgSrc, index) => (
                  <img 
                    ...
                    onClick={ () => handleImaheClick(imgSrc, index)}
          ...
          <div className='container-mapa-atajos-estaciones'>
              <div id='container-mapa-interactivo-example'>
          ...
          <div className='accordion'>
            {
              Object.entries(rutas.instrucciones).map(([key, value], index) => (
                <div key={key} className='accordion-item1'>
                  ...
                  >
                    {typeof value === 'string' ? (
                      <p>{value}</p> // Si el valor es una cadena, lo mostramos directamente
                    ) : typeof value === 'object' ? (
                      // Si el valor es un objeto (como emergencias), lo recorremos
